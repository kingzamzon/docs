...
To obtain the Lit Test Token, please fill out the [Faucet Request Form](https://forms.gle/5pALfdNHkwXoRF5r8). The Lit Test Token will be sent to your wallet address, allowing you to perform test transactions on the rollup.
