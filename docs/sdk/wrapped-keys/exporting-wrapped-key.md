...
This is the unique identifier (UUID v4) generated by Lit for the Wrapped Key, when it either [imported](./importing-key.md) or [generated](./generating-wrapped-key.md).
