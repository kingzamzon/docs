...
2. [Custom Auth / Adding new Auth Methods not yet supported by Lit](#custom-auth--adding-new-auth-methods-not-yet-supported-by-lit)
...
Check out the implementation details within the SDK section [here](auth-methods/overview).
