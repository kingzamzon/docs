...
To obtain the `LIT` test token, please use the faucet at https://chronicle-faucet-app.vercel.app/. The `LIT` test token will be sent to your wallet address, allowing you to perform test transactions on the rollup.
