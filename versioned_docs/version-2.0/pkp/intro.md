...
3. Concept: [Assigning an Authentication Method](../pkp/authHelpers/overview.md) (and associated [blog post](https://spark.litprotocol.com/how-authentication-works-with-pkps/))
4. SDK Package: [Using PKPs as Wallets](../pkp/usage) 

## Overview

Each Programmable Key Pair (PKP) is a versatile [MPC wallet](../pkp/usage) that can be utilized by developers to:
